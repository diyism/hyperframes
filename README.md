    https://x.com/ai_muzi/status/2046570897251709253
    视频中演示的核心提示词我已总结打包如下（Hyperframe + AI视频编辑流程，复制直接用）：
    
    【主提示（第一版）】
    直接在搭好的 HyperFrames 工程开始第一版。
    目标：只做前15-20秒开头，更抓人，像高质量YouTube科技/AI教学视频开场。
    要求：
    - 保留原视频主体清晰
    - 节奏更强
    - 合理加屏幕大字、底部字幕
    - 合适位置人物切换、图表/信息卡/callout
    - 少量自然转场
    - 整体高级干净现代，不要太花或廉价模板
    - 先做V1，别塞太多效果
    - 最抓人信息放最前
    
    完成后：1. 直接render第一版视频 2. 告诉我具体做了哪些效果。
